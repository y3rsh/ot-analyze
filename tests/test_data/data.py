...
JSON_POSITIVE: Path = Path(Path(__file__).parent, "json", "protocol.json")
JSON_ERROR: Path = Path(Path(__file__).parent, "json_error", "protocol.json")
# Creating an array of these paths
ALL: List[Path] = [POSITIVE_OT2, POSITIVE_FLEX, ERROR, NO_CI, NO_PROTOCOL, FLEX_ERROR, JSON_POSITIVE, JSON_ERROR]
